...
<!-- Page Title -->
<section class="section page-title-section theme-after bg-fixed bg-center-center bg-cover" style="background-image: url(static/img/overlay-2.jpg);">
  <div class="container">
      ...
      <div class="card border-primary">
        ...
        <div class="page-wrapper">
          ...
          <header class="page-header">
            <h1 class="text-dark text-center">Privacy Policy</h1>
          </header>
          ...
          <div class="copy-page">
            ...
            <div class="copy-body">
							...
							<div class="copy-block">
								...
								<p>This website is operated by Fast Poll. We take your privacy very seriously therefore we urge to read this policy very carefully because it contains important information about on:</p>
								<ul>
								<li>who we are,</li>
							...
							<div class="copy-block">
								...
								<p>Fast Poll ('we' or 'us') (trading as Jamie Peak Design and Development)  collect, use and are responsible for certain personal information about you. When we do so we are regulated under the General Data protection Regulations which apply across the European Union (including the United Kingdom) and we are responsible as 'controller' of that personal information for the purposes of those laws.</p>
							...
							<div class="copy-block">
								...
								<p><span>Name<br>Email Address</span></p>
								<p>Some examples of when we collect this information include:</p>

								<p><span>When creating a Fast Poll account<br>When you update your Fast Poll settings page</span></p>
								<p><br><span>b) Personal information you provide about third parties</span></p>
								...
								<p>shall consent on their behalf to the processing of their personal data;<br>shall receive any data protection notices on their behalf; and<br>shall consent on their behalf to the transfer of their personal data abroad.</p>
								<p><br>c)<span> Cookies and similar technologies</span></p>
								...
								<p><span>We use cookies to remember some visual preferences and your session details.</span></p>
								...
								<p>On the first occasion that you use our site we will ask whether you consent to our use of cookies. If you do not you cannot continue to use our site.</p>
								<p>For further information on cookies generally visit www.aboutcookies.org or www.allaboutcookies.org.</p>

								<p>We may store a visitors IP address, the name of the browser you are using, browser version number and the operating system you used to vote or create a poll from to improve the Fast Poll system and improve reliability of our service. The IP address, the browser name, browser version number and the operating system is not and will never be associated with any personal information and is isolated from any idividuals personal user information we may hold.</p>
								...
								<p><span>Marketing, website customisation, preference analysis</span></p>

								<p><strong>Who your information may be shared with</strong></p>
								...
								<p><strong>Whether personal information has to be provided by you, and if so why</strong></p>
								...
								<p><span>Name and Email address is required for account creation purposes.</span></p>
								...
								<p><span>Your personal information will be kept indefinitely until you delete your account. You can delete your account and all associated data at any time. To do so please visit your Fast Poll settings page</span></p>
								<p><strong>Reasons we can collect and use your personal information</strong></p>
							...
							<div class="copy-block">
								...
								<p>We will also use technological and organisation measures to keep your information secure. These measures may include the following examples:</p>
								<p><span>User account access is controlled by a unique username and encrypted password.<br>All data is stored on secure servers and is encrypted using SSL.</span></p>
							...
							<div class="copy-block">
								...
								<p>This privacy policy was published on <span>3/11/2018</span> and last updated on <span>30/01/2020</span>.</p>
								...
								<p><span>By notice on the website.</span></p>
