...
<head>
  ...
  <!--
  ========================================================================
  Developed and designed by Nalin Nishant
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  Contact Him On Instagram - https://instagram.com/its._nalin_
  ========================================================================
  -->
  <!-- Page Title -->
  <title>Online Free Poll</title>
  <!-- / -->
  ...
  <link href="assets/css/default.css" rel="stylesheet" id="color_theme">
  <!-- / -->
  <style>
  .choose_file{
  position: relative;
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbar">
          <ul class="navbar-nav ml-auto">
            <li><a class="nav-link active" href="index.php">Home</a>
             </li>
            <li><a class="nav-link" href="about.php">About</a></li>
            <li><a class="nav-link" href="privacy.php">Privacy Policy</a></li>
            <li><a class="nav-link" href="faq.php">FAQ</a></li>
            <li><a class="nav-btn nav-link" href="poll.php">Create Poll</a></li>
          </ul>
        </div>
        <!-- / -->
